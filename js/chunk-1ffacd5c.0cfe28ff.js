(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-1ffacd5c"], {
    ...
    "25f0": function(e, t, o) {
        ...
        var n = o("6eeb")
          ...
          , p = c.name != r;
        (u || p) && n(RegExp.prototype, r, (function() {
            var e = l(this)
              , t = String(e.source)
              , o = e.flags
    ...
    5319: function(e, t, o) {
        ...
        n("replace", 2, (function(e, t, o, n) {
            ...
            return [function(o, n) {
                ...
                return void 0 !== a ? a.call(o, l, n) : t.call(String(l), o, n)
            }
            , function(e, n) {
                if (!g && S || "string" === typeof n && -1 === n.indexOf(v)) {
                    var a = o(t, e, this, n);
                    if (a.done)
                        return a.value
                }
                ...
                while (1) {
                    ...
                    !h)
                        break;
                    var _ = String(y[0]);
                    "" === _ && (s.lastIndex = c(m, i(s.lastIndex), R))
                }
                for (var A = "", k = 0, w = 0; w < x.length; w++) {
                    y = x[w];
                    for (var L = String(y[0]), U = p(f(r(y.index), m.length), 0), $ = [], O = 1; O < y.length; O++)
                        $.push(b(y[O]));
                    var E = y.groups;
                    if (d) {
                        var N = [L].concat($, U, m);
                        void 0 !== E && N.push(E);
                        var T = String(n.apply(void 0, N))
                    } else
                        T = C(L, m, U, $, E, n);
                    U >= k && (A += m.slice(k, U) + T,
                    k = U + L.length)
            ...
            function C(e, o, n, l, i, r) {
                var s = n + e.length
                  , c = l.length
                  , u = h;
                return void 0 !== i && (i = a(i),
                u = d),
                t.call(r, u, (function(t, a) {
                    var r;
                    switch (a.charAt(0)) {
                    case "$":
                        return "$";
                    ...
                    default:
                        ...
                        if (u > c) {
                            var p = m(u / 10);
                            return 0 === p ? t : p <= c ? void 0 === l[p - 1] ? a.charAt(1) : l[p - 1] + a.charAt(1) : t
                        }
                        r = l[u - 1]
                    }
                    return void 0 === r ? "" : r
    ...
    6547: function(e, t, o) {
        var n = o("a691")
          ...
          , a = function(e) {
            return function(t, o) {
                var a, i, r = String(l(t)), s = n(o), c = r.length;
                return s < 0 || s >= c ? e ? "" : void 0 : (a = r.charCodeAt(s),
                a < 55296 || a > 56319 || s + 1 === c || (i = r.charCodeAt(s + 1)) < 56320 || i > 57343 ? e ? r.charAt(s) : a : e ? r.slice(s, s + 2) : i - 56320 + (a - 55296 << 10) + 65536)
            }
        };
        e.exports = {
            codeAt: a(!1),
    ...
    9263: function(e, t, o) {
        ...
        var n = o("ad6d")
          ...
          , p = s || u || c;
        p && (r = function(e) {
            var t, o, l, r, p = this, f = c && p.sticky, m = n.call(p), d = p.source, h = 0, b = e;
            return f && (m = m.replace("y", ""),
            -1 === m.indexOf("g") && (m += "g"),
            b = String(e).slice(p.lastIndex),
            ...
            s && (t = p.lastIndex),
            l = a.call(f ? o : p, b),
            f ? l ? (l.input = l.input.slice(h),
            l[0] = l[0].slice(h),
            l.index = p.lastIndex,
            p.lastIndex += l[0].length) : p.lastIndex = 0 : s && l && (p.lastIndex = p.global ? l.index + l[0].length : t),
            u && l && l.length > 1 && i.call(l[0], o, (function() {
                for (r = 1; r < arguments.length - 2; r++)
                    void 0 === arguments[r] && (l[r] = void 0)
            }
            )),
            l
        }
    ...
    a9c7: function(e, t, o) {
        ...
        o("25f0"),
        o("5319"),
        "https://52tv.github.io")
          , i = "https://raw.githubusercontent.com/tindy2013/subconverter/master/base/config/example_external_config.ini"
          , r = "https://github.com/tindy2013/subconverter/releases"
          , s = "https://api.wcc.best/sub?"
          , c = "https://api.suo.yt/short"
          , u = "https://api.wcc.best/config/upload"
          , p = "https://t.me/wuyoukeji"
          , f = {
            data: function() {
                var e = {
                    backendVersion: "",
                ...
                if (t) {
                    for (var o = e.options.remoteConfig[1].options, n = 0; n < o.length; n++)
                        o[n].label.length > 10 && (o[n].label = o[n].label.replace(/\s.*/, ""));
                    for (var l = {}, a = Object.keys(e.options.customBackend), r = 0; r < a.length; r++) {
                        var s = a[r].replace(/\(.*/, "");
                        l[s] = e.options.customBackend[a[r]]
                    }
            ...
            methods: {
                ...
                clashInstall: function() {
                    if ("" === this.customSubUrl)
                        return this.$message.error("请先填写必填项，生成订阅链接"),
                        !1;
                ...
                makeUrl: function() {
                    ...
                    if ("" === this.form.sourceSubUrl || "" === this.form.clientType)
                        return this.$message.error("订阅链接与客户端为必填项"),
                        !1;
                    ...
                    if (n = n.replace(/(\n|\r|\n\r)/g, "|"),
                    -1 !== n.indexOf("losadhwse") && (-1 !== t.indexOf("py6.pw") || -1 !== t.indexOf("subconverter-web.now.sh") || -1 !== t.indexOf("subconverter.herokuapp.com") || -1 !== t.indexOf("api.wcc.best")))
                        return this.$alert("此机场订阅已将该后端屏蔽，请自建后端转换。", "转换错误提示", {
                    ...
                    "2" === this.advanced && ("" !== this.form.excludeRemarks && (this.customSubUrl += "&exclude=" + encodeURIComponent(this.form.excludeRemarks)),
                    ...
                    this.form.appendType && (this.customSubUrl += "&append_type=" + this.form.appendType.toString()),
                    this.customSubUrl += "&emoji=" + this.form.emoji.toString() + "&list=" + this.form.nodeList.toString() + "&udp=" + this.form.udp.toString() + "&tfo=" + this.form.tfo.toString() + "&scv=" + this.form.scv.toString() + "&fdn=" + this.form.fdn.toString() + "&sort=" + this.form.sort.toString(),
                    !0 === this.form.tpl.surge.doh && (this.customSubUrl += "&surge.doh=true"),
                    "clash" === this.form.clientType && (this.customSubUrl += "&new_name=" + this.form.new_name.toString())),
                ...
                makeShortUrl: function() {
                    var e = this;
                    if ("" === this.customSubUrl)
                        return this.$message.warning("请先生成订阅链接，再获取对应短链接"),
                        !1;
                    this.loading = !0;
                    var t = new FormData;
                    ...
                    this.$axios.post(c, t, {
                        ...
                        1 === t.data.Code && "" !== t.data.ShortUrl ? (e.curtomShortSubUrl = t.data.ShortUrl,
                        e.$copyText(t.data.ShortUrl),
                        e.$message.success("短链接已复制到剪贴板")) : e.$message.error("短链接获取失败：" + t.data.Message)
                    }
                    )).catch((function() {
                ...
                confirmUploadConfig: function() {
                    ...
                    if ("" === this.uploadConfig)
                        return this.$message.warning("远程配置不能为空"),
                        !1;
                    this.loading = !0;
                    var t = new FormData;
                    ...
                    this.$axios.post(u, t, {
                        ...
                        1 === t.data.Code && "" !== t.data.url ? (e.$message.success("远程配置上传成功，配置链接已复制到剪贴板，有效期三个月望知悉"),
                        e.form.remoteConfig = t.data.Url,
                        e.$copyText(e.form.remoteConfig),
                        e.dialogUploadConfigVisible = !1) : e.$message.error("远程配置上传失败：" + t.data.Message)
                    }
                    )).catch((function() {
          ...
          , m = f
          , d = o("2877")
          , h = Object(d["a"])(m, n, l, !1, null, null, null);
        t["default"] = h.exports
    },
    ac1f: function(e, t, o) {
        "use strict";
    ...
    d784: function(e, t, o) {
        ...
        e.exports = function(e, t, o, p) {
            ...
            if (!h || !b || "replace" === e && (!c || !u || f) || "split" === e && !m) {
                var g = /./[d]
                  , S = o(d, ""[e], (function(e, t, o, n, l) {
                    return t.exec === i ? h && !l ? {
                        done: !0,
                        value: g.call(t, o, n)
                    } : {
                ...
                n(RegExp.prototype, d, 2 == t ? function(e, t) {
            ...
            p && r(RegExp.prototype[d], "sham", !0)
        }
    }
}]);
//# sourceMappingURL=chunk-1ffacd5c.0cfe28ff.js.map
